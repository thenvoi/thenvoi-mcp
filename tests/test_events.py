...
class TestCreateAgentChatEvent:
    ...
    def test_creates_thought_event(self, mock_ctx, mock_agent_api_events):
        ...
        mock_agent_api_events.create_agent_chat_event.return_value = factory.response(
            event
        )
        ...
        mock_agent_api_events.create_agent_chat_event.assert_called_once()
        call_args = mock_agent_api_events.create_agent_chat_event.call_args
    ...
    def test_creates_tool_call_event(self, mock_ctx, mock_agent_api_events):
    ...
    def test_creates_tool_result_event(self, mock_ctx, mock_agent_api_events):
    ...
    def test_creates_error_event(self, mock_ctx, mock_agent_api_events):
    ...
    def test_creates_task_event(self, mock_ctx, mock_agent_api_events):
    ...
    def test_creates_event_without_metadata(self, mock_ctx, mock_agent_api_events):
    ...
    def test_message_type_is_case_insensitive(self, mock_ctx, mock_agent_api_events):
    ...
    def test_raises_on_invalid_message_type(self, mock_ctx):
    ...
    def test_raises_on_invalid_metadata_json(self, mock_ctx):
    ...
    def test_all_valid_event_types_accepted(
        self, mock_ctx, mock_agent_api_events, event_type
    ):
